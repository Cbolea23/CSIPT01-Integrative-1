...
urlpatterns = [
    ...
    path('api/customers/<int:pk>/', views.CustomerDetailAPI.as_view(), name='customer-detail'),
    path('api/products/<int:pk>/', views.ProductDetailAPI.as_view(), name='product-detail'),
]